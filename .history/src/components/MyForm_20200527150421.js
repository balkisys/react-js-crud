   ...
   render() {
      ...
      <form className= "ui form"> 
       <div className="fields">
           ...
           <input type="text" name="first_name" placeholder="First Name" value={this.state.form.first_name} />
           </div>

           <div className="four wide field"> 
           <label> Last Name </label>
           <input type="text" name="last_name" placeholder="Last Name"  value={this.state.form.last_name} />
           </div>
